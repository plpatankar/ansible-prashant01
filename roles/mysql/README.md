...
This role nstalls and configures MySQL or MariaDB server on RHEL/CentOS or Debian/Ubuntu servers.

## Prerequisites

This role requires root access, so either run it in a playbook with a global `become: yes`, or invoke role in playbook as below:
...
This role was created in 2017 by ATMF team
